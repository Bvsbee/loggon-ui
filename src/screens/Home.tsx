...
import {ShoppingOutlined, RocketOutlined, SafetyCertificateOutlined} from "@ant-design/icons";
  ...
  return (
    <AppLayout>
      <Content style={{
        ...
        {/* Company Info & CTA */}
        <div style={{textAlign: "center", marginBottom: "50px", maxWidth: "1200px", width: "100%", margin: "0 auto"}}>
          <h1 style={{fontSize: "36px", fontWeight: "bold"}}>Welcome to LoggOn!</h1>
          <p style={{fontSize: "18px", maxWidth: "800px", margin: "0 auto"}}>
            Loggon is your trusted source for high-quality exotic wood species. We provide premium selections with fast shipping and excellent service.
          </p>
          <Button type="primary" size="large" style={{margin: "20px"}}>
            Shop Now <ShoppingOutlined />
          </Button>
          <Button size="large" style={{margin: "20px", background: "#606c38", color: "white"}}>
        ...
        <Row gutter={[16, 16]} justify="center">
          ...
          <Col xs={24} md={8} style={{textAlign: "center"}}>
            <SafetyCertificateOutlined style={{fontSize: "40px", color: "#606c38"}} />
        ...
        {/* New Arrivals */}
        <div style={{marginTop: "50px", maxWidth: "1200px", width: "100%", margin: "0 auto", textAlign: "center"}}>
